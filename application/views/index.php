        ...
        <div class="gla_slider gla_image_bck  gla_wht_txt gla_fixed" data-image="<?= base_url('assets') ?>/images/tes2.jpg" data-stellar-background-ratio="0.8">
            ...
            <div class="container">
                ...
                <div class="gla_slide_txt gla_slide_center_bottom text-center">
                    <p><img src="<?= base_url('assets') ?>/images/animations/ourwedding_wh.gif" data-top-bottom="@src:images/animations/ourwedding_wh.gif" alt="" height="150"></p>
        ...
        <section id="gla_content" class="gla_content">
            ...
            <section class="gla_section">
                ...
                <div class="container text-center">
                    <p><img src="<?= base_url('assets') ?>/images/animations/flower6.gif" data-bottom-top="@src:images/animations/flower6.gif; opacity:1" class="gla_animated_flower" height="110" alt=""></p>
            ...
            <section class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0.8" data-image="http://placehold.it/1400x800">
                ...
                <div class="container text-center">
                    <p><img src="<?= base_url('assets') ?>/images/animations/savethedate_wh.gif" data-bottom-top="@src:images/animations/savethedate_wh.gif" height="150" alt=""></p>
                    <h2>13 Maret, 2022</h2>
            ...
            <section class="gla_section">
                ...
                <div class="container text-center">
                    <p><img src="<?= base_url('assets') ?>/images/animations/flowers2.gif" data-bottom-top="@src:images/animations/flowers2.gif" height="150" alt=""></p>
                    <h2>Wedding Details</h2>
                    <h3 class="gla_subtitle">When & Where</h3>
                    <p>Our ceremony and reception will be held at the Liberty House. Located on the Hudson River, it has a beautiful, unobstructed view of the World Trade One building and a convenient ferry that runs between it and Manhattan.</p>
                    <!-- boxes -->
            ...
            <section class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0.8" data-image="http://placehold.it/1400x800">
                ...
                <div class="container text-center">
                    <p><img src="<?= base_url('assets') ?>/images/animations/just_wh.gif" data-bottom-top="@src:images/animations/just_wh.gif" height="150" alt=""></p>
            ...
            <section class="gla_section gla_image_bck">
                ...
                <div class="container text-center">
                    <p><img src="<?= base_url('assets') ?>/images/animations/flowers3.gif" data-bottom-top="@src:images/animations/flowers3.gif" height="130" alt=""></p>
                        ...
                        <div class="col-sm-4 gla_anim_box grid-item ceremony">
                            <div class="gla_shop_item">
                                <a href="http://placehold.it/1400x800" class="lightbox">
                                    <img src="<?= base_url('assets') ?>/images/foto1.jpg" alt="">
                                </a>
                            </div>
                        </div>
            ...
            <section class="gla_section">
                ...
                <div class="container text-center">
                    <p><img src="<?= base_url('assets') ?>/images/animations/rsvp.gif" data-bottom-top="@src:images/animations/rsvp.gif" height="180" alt=""></p>
            ...
            <section class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0.8" data-image="http://placehold.it/1400x800">
                ...
                <div class="container text-center">
                    <p><img src="<?= base_url('assets') ?>/images/animations/thnyou_wh.gif" alt="" height="200" data-bottom-top="@src:images/animations/thnyou_wh.gif"></p>
